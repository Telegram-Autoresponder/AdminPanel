...
from app.pkg.models.exceptions.collect_response import EmptyResult

__all__ = ["collect_response"]


def collect_response(fn, returned_none: bool=False):
    ...
    Args:
        ...
        returned_none:
            Flag. declare can method return None or not.
    ...
    async def inner(
        ...
        **kwargs: object,
        ...
        if not response and returned_none:
            raise EmptyResult
